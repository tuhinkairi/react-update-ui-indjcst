        ...
        <div key={keyProp} className=" rounded-md overflow-hidden border border-gray-200 max-w-[400px] mx-auto">
            ...
            <div className="p-5">
                <h2 onClick={handelNavigate} className="bg-gradient-to-r from-primary to-primary-hover bg-clip-text text-transparent text-2xl  mb-3 leading-snug font-serif relative cursor-pointer">
                    {blog.title}
                    <button onClick={handelNavigate} className="absolute right-0 sm:hidden text-white font-medium rounded-full bg-gradient-to-b from-primary to-primary-hover hover:from-[#5C6BC01A] hover:to-[#5C6BC01A] hover:text-primary-text transition p-2">
                ...
                <div className="flex items-end justify-between ">
                    ...
                    <button onClick={handelNavigate} className="hidden sm:inline-block text-white font-medium rounded-full bg-gradient-to-b from-primary to-primary-hover hover:from-[#5C6BC01A] hover:to-[#5C6BC01A] hover:text-primary-text transition p-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 -rotate-45" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                        </svg>
