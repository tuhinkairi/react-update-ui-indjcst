        ...
        <div className="w-full flex justify-center items-center text-[#333333]">
          <div className="">
            ...
            <p className=" leading-[1.9] my-5">
              International Journal of Innovative Research in Engineering (IJIRE) is (Online), Bi-monthly international journal for publication of new ideas founded by academicians, educationist, engineers and corporate people. The research results and fund FDRP ental advancement are all aspects of Innovative Research in Advanced Engineering &amp; Technology and various engineering disciplines, etc. IJIRE is a scholarly open access, Peer Review Journal which helps to academic person as well as student community. IJIRE provides the academic community and industry for the submission of original research and applications related to Various Engineering discipline and Advanced Technologies by Fifth Dimension Research Publications (FDRP) Tamil Nadu, India since year 2020.
            </p>
