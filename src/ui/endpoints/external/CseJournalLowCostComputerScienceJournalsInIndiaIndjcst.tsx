      ...
      <CommonLayout>
        ...
        <section className="py-5">
          <h1 className="text-3xl font-bold mb-6">
            🟩 About INDJCST – Leading Low-Cost CSE Journal
          </h1>
          <p className="text-lg leading-relaxed mb-6">
            The Indian Journal of Computer Science and Technology (INDJCST) is a
            prominent CSE journal and one of the most reliable low-cost computer
            science journals in India. Published three times a year, INDJCST
            offers an open-access, peer-reviewed platform for academicians,
            educators, researchers, engineers, and industry professionals to
            share innovative research across all domains of Computer Science and
            emerging technologies.
          </p>
          <p className="mb-6">
            Adhering strictly to UGC-CARE guidelines, INDJCST ensures a rigorous
            peer-review process and maintains the highest standards of scholarly
            integrity, making it an ideal platform for affordable computer
          ...
          <p>
            INDJCST supports interdisciplinary research and practical
            applications of computing, establishing itself among the top low-cost
            computer science journals accessible to Indian and international
            researchers.
          </p>
        </section>
        ...
        <section className="py-10 px-5 bg-gray-50">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>🌐 Open Access – Your work reaches global audiences instantly.</li>
            <li>✅ Efficient Publication Process – Streamlined workflow for hassle-free publication.</li>
            <li>🔒 Plagiarism Protection – Advanced screening ensures integrity.</li>
            <li>📜 COPE Compliance – Following international publication ethics.</li>
            <li>🌟 Global Impact – Influencing innovation, adoption, and policy-making.</li>
          </ul>
        </section>
        ...
        <section className="py-10">
          ...
          <p className="mb-4">
            INDJCST is widely indexed for maximum visibility:
          </p>
          <p>
        ...
        <section className="py-10 px-5 bg-gray-50">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>📩 Submit Online – 24/7 through our editorial system</li>
        ...
        <section className="py-10">
          ...
          <p className="mb-4">
            Open-access publication with minimal fees, making it one of the most
            affordable computer science journals:
          </p>
          <ul className="list-disc list-inside space-y-2">
        ...
        <section className="py-10 px-5 bg-gray-50">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Author Dashboard – Personalized account with submission history and status updates</li>
...
export default CseJournalLowCostComputerScienceJournalsInIndiaIndjcst;
